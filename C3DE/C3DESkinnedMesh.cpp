...
m_vertices3->push_back(VertexPosBones(1.000000f, 1.000000f, -1.000000f, 0.577349f, 0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(1.000000f, -1.000000f, -1.000000f, 0.577349f, -0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(-1.000000f, -1.000000f, -1.000000f, -0.577349f, -0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(-1.000000f, 1.000000f, -1.000000f, -0.577349f, 0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(1.000000f, 0.999999f, 1.000000f, 0.577349f, 0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(-1.000000f, 1.000000f, 1.000000f, -0.577349f, 0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(-1.000000f, -1.000000f, 1.000000f, -0.577349f, -0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(0.999999f, -1.000001f, 1.000000f, 0.577349f, -0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(1.000000f, 1.000000f, -1.000000f, 0.577349f, 0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(1.000000f, 0.999999f, 1.000000f, 0.577349f, 0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(0.999999f, -1.000001f, 1.000000f, 0.577349f, -0.577349f, 0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
m_vertices3->push_back(VertexPosBones(1.000000f, -1.000000f, -1.000000f, 0.577349f, -0.577349f, -0.577349f, 0.000000f, 0.000000f, 1.000000f, -1, -1));
...
m_indices->push_back(23);
	...
	HR(t_device->CreateVertexDeclaration(VertexPosElements, &VertexPosBones::Decl));

	
	D3DVERTEXELEMENT9 elems[MAX_FVF_DECL_SIZE];
	UINT numElems = 0;
	HR(VertexPosBones::Decl->GetDeclaration(elems, &numElems));
	...
	t_effect->SetRootMatrices(m_roots, 44);
...
void C3DESkinnedMesh::SetShaderHandlers()
{
	...
	t_effect->SetFrameRootMatrices(m_currentFrameToRoots, 44);
...
C3DESkinnedMesh::C3DESkinnedMesh()
{
	...
	m_indices->push_back(23);	
#endif
	D3DImage * d3dImage = new D3DImage(ResourceManager::GetInstance()->GetTextureByID(IMAGE_CAFE_TABLE_ID));	
	AddTexture((Image *) d3dImage);
