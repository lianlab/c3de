...
OutputVS GrassVS(float3 posL : POSITION0, float3 normalL : NORMAL0, float2 tex0: TEXCOORD0)
{
    // Zero out our output.
...
float4 GrassPS(float4 c : COLOR0, float4 spec : COLOR1, float2 tex0 : TEXCOORD0, float fogLerpParam:TEXCOORD1) : COLOR
{
