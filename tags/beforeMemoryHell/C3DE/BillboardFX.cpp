...
BillboardFX::~BillboardFX()
{

}

void BillboardFX::ResetHandlers()
{
	D3DXMATRIX T;
...
void BillboardFX::SetObjectMaterials(D3DXCOLOR ambientMaterial, D3DXCOLOR diffuseMaterial,
...
void BillboardFX::SetObjectTexture(IDirect3DTexture9 *texture)
{
	HR(m_effect->SetTexture(m_hTex, texture));
}

//void BillboardFX::SetAlpha(float alpha)
//{
//	HR(m_effect->SetFloat(m_shaderAlpha, alpha));
//}

void BillboardFX::SetWorldHandlers(D3DXVECTOR3 cameraPosition, D3DXMATRIX worldViewProjection)
{
