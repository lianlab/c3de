...
SpecularLightFX::SpecularLightFX(ID3DXEffect *effect):
FX(effect)
{
...
SpecularLightFX::~SpecularLightFX()
{

}

void SpecularLightFX::ResetHandlers()
{
	D3DXMATRIX T;
...
void SpecularLightFX::SetObjectMaterials(D3DXCOLOR ambientMaterial, D3DXCOLOR diffuseMaterial,
...
void SpecularLightFX::SetObjectTexture(IDirect3DTexture9 *texture)
{
	if(texture)
	{
...
void SpecularLightFX::SetAlpha(float alpha)
{
